...
func (m *SnippetModel) Get(id int) (Snippet, error) {
	...
	err := m.DB.QueryRow(`SELECT id, title, content, created, expires FROM snippets WHERE expires > UTC_TIMESTAMP() AND id = ?`).Scan(&s.ID, &s.Title, &s.Content, &s.Created, &s.Expires)
